  ...
  return (
    ...
    >
      <div className="text-center max-w-3xl px-4">
        ...
        <button className="mt-8 px-6 py-3 font-semibold text-black bg-white rounded-full shadow-lg hover:bg-gray-200">
          Get started now →
        </button>
      </div>
      ...
      <footer className="mt-24 mb-6 w-full max-w-5xl px-4 ">
        <div className="flex flex-wrap justify-center gap-20 text-sm font-light mt-14">
          <div className="space-y-2 text-center md:text-left md:space-y-14">
            <h3 className="font-bold text-lg">Product</h3>
            <br />

            <ul className="flex flex-col gap-10 space-y-10">
              <li>Editor</li>
              <br />
              <li>Collaboration</li>
              <br />
        ...
        <div className="mt-8 text-center text-xs text-gray-400">
          © 2024 Open-hub&nbsp;&nbsp; System status &nbsp;&nbsp; Privacy policy
          &nbsp;&nbsp; Terms &nbsp;&nbsp; Legal notice
        </div>
      </footer>
    </div>
